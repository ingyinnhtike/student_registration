...
return [
    ...
    'is_diploma'=>false,
    'year' => ['Master First Year', 'Master Second Year'],
    'years_to_seed' => [
        [
    ...
    'majors' => [
        ...
        'psyscho' => 'စိတ်ပညာ',
        'law' => 'ဥပဒေပညာ',
        'eastern' => 'အရှေ့တိုင်းပညာ',
        'ir' => 'နိုင်ငံတကာဆက်ဆံရေးပညာ',
        'human' => 'မနုဿဗေဒ',
        'ancient' => 'ရှေးဟောင်းသုတေသနပညာ',
        'weather' => 'မိုးလေဝသပညာ',
        'chemistry' => 'ဓာတုဗေဒ',
        'physics' => 'ရူပဗေဒ',
        'math' => 'သင်္ချာ',
    ...
    'majors_to_seed' => [
        ...
        ['name_en' => 'Oriental study', 'name' => 'အရှေ့တိုင်းပညာ', 'key' => 'eastern',],
        ['name_en' => 'International Relations', 'name' => 'နိုင်ငံတကာဆက်ဆံရေးပညာ', 'key' => 'ir'],
        ['name_en' => 'Anthropology', 'name' => 'မနုဿဗေဒ', 'key' => 'human'],
        ['name_en' => 'Archeology', 'name' => 'ရှေးဟောင်းသုတေသနပညာ', 'key' => 'ancient',],
        ['name_en' => 'Meteorology', 'name' => 'မိုးလေဝသပညာ', 'key' => 'weather'],
        ...
        ['name_en' => 'Industrial Chemistry', 'name' => 'ကုန်ထုတ်ဓာတုဗေဒ', 'key' => 'ic'],
    ],
    'exam_subjects' => [
        'mm' => 'မြန်မာစာ',
        'eng' => 'အင်္ဂလိပ်စာ',
    ...
    'exam_years' => [
        ...
        2 => 'ဒုတိယနှစ်',
        3 => 'တတိယနှစ် / Honest-1',
        4 => 'စတုတ္ထနှစ် / Honest-2',
        5 => 'ပဉ္စမနှစ် / Honest-3',
        6 => 'Qualified',
        7 => 'Master-1',
        8 => 'Master-2'
    ],
